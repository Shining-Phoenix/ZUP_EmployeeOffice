...
Процедура ЛК_ЗаполнитьДанныеПоСотруднику(ДокументРезультат, ОбластьДанныеОВремени, ДанныеПоСотруднику)
	...
	СтруктураМесяца.Вставить("employee",         ДанныеПоСотруднику.Сотрудник); 
	СтруктураМесяца.Вставить("tabNom",           ДанныеПоСотруднику.СотрудникКод); 
	СтруктураМесяца.Вставить("organizationName", ДанныеПоСотруднику.ОрганизацияНаименованиеПолное); 	
	СтруктураМесяца.Вставить("positionName",     ДанныеПоСотруднику.ДолжностьНаименование); 	
	//---
