...
Процедура СоздатьРасчетныеЛисткиНаСервере()
	...
	Пока Выборка.Следующий() Цикл  
		...
		Результат = ЛК_ОбменДаннымиСервер.ДобавитьОбновитьРасчетныйЛист(НастройкиСервиса, Токен, "", Выборка.ПериодДействия, Выборка.Организация, Выборка.ФизическоеЛицо); 
