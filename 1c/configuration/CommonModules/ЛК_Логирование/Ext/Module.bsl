...
Функция УровниЛога() Экспорт
	...
	Структура.Вставить("Трасса", "Trace");
...
Функция ДанныеJSONОбъектСтрока(dateTime, id = "", type, description, object, trace, errore = "") Экспорт
...
Функция ДанныеJSONОбъектJSON(dateTime, id = "", type, description, object, trace, errore = "") Экспорт
