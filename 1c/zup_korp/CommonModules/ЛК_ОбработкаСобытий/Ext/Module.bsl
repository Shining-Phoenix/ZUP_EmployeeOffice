...
Процедура ЗарегистрироватьЗаписьРегистраНакоплений(НаборЗаписей) Экспорт  
	...
	Если НаборЗаписей.Метаданные().Имя = "НачисленияУдержанияПоСотрудникам"  Тогда
		Запрос = Новый Запрос;
